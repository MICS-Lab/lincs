...
void define_problem_classes() {
  {
    bp::scope scope(
      bp::class_<lincs::Criterion>("Criterion", "A classification criterion, to be used in a classification ``Problem``", bp::no_init)
    ...
    bp::class_<lincs::Criterion::IntegerValues>(
      "IntegerValues",
    ...
    bp::class_<lincs::Criterion::EnumeratedValues>(
      "EnumeratedValues",
...
void define_model_classes() {
  {
    bp::scope scope(
      bp::class_<lincs::AcceptedValues>("AcceptedValues", bp::no_init)
    ...
    auto_enum<lincs::AcceptedValues::Kind>("Kind", "The different kinds of descriptors for accepted values");

    bp::class_<lincs::AcceptedValues::RealThresholds>(
      "RealThresholds",
    ...
    bp::class_<lincs::AcceptedValues::IntegerThresholds>(
      "IntegerThresholds",
    ...
    bp::class_<lincs::AcceptedValues::EnumeratedThresholds>(
  ...
  {
    bp::scope scope(
      bp::class_<lincs::SufficientCoalitions>("SufficientCoalitions", bp::no_init)
    ...
    auto_enum<lincs::SufficientCoalitions::Kind>("Kind", "The different kinds of descriptors for sufficient coalitions");

    bp::class_<lincs::SufficientCoalitions::Weights>(
      "Weights",
    ...
    bp::class_<lincs::SufficientCoalitions::Roots>(
      "Roots",
