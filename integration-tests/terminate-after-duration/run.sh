...
time lincs learn classification-model problem.yml learning-set.csv --mrsort.weights-profiles-breed.max-duration-seconds 15 --output-model trained-model--finished.yml --mrsort.weights-profiles-breed.accuracy-heuristic.random-seed 42
diff <(echo 2000/2000) <(lincs classification-accuracy problem.yml trained-model--finished.yml learning-set.csv)

lincs learn classification-model problem.yml learning-set.csv --mrsort.weights-profiles-breed.max-duration-seconds 5 --output-model trained-model--interrupted.yml --mrsort.weights-profiles-breed.accuracy-heuristic.random-seed 42
