...
lincs learn classification-model problem.yml learning-set.csv --mrsort.weights-profiles-breed.max-duration 5 --output-model trained-model--interrupted.yml --mrsort.weights-profiles-breed.accuracy-heuristic.random-seed 42
