...
lincs learn classification-model problem.yml learning-set.csv --mrsort.weights-profiles-breed.max-duration-seconds 15 --output-model trained-model--finished.yml --mrsort.weights-profiles-breed.accuracy-heuristic.random-seed 42
